...
void as::priv::RegShader(asIScriptEngine* eng)
{
	...
	AS_ASSERT(eng->RegisterObjectMethod("Shader", "void set_opIndex(const string&in, const Shader::CurrentTexture_t@)", asMETHODPR(sf::Shader, setUniform, (const std::string&, sf::Shader::CurrentTextureType), void), asCALL_THISCALL));
...
#else
	AS_ASSERT(eng->RegisterObjectMethod("Shader", "void set_opIndex(const string&in, const Shader::CurrentTexture_t@)", asMETHODPR(sf::Shader, setParameter, (const std::string&, sf::Shader::CurrentTextureType), void), asCALL_THISCALL));
